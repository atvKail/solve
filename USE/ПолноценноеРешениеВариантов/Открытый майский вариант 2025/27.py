...
def main() -> int:
    path_A = "USE\\ПолноценноеРешениеВариантов\\Открытый майский вариант 2025\\27_A_21911.txt"
    path_B = "USE\\ПолноценноеРешениеВариантов\\Открытый майский вариант 2025\\27_B_21911.txt"
